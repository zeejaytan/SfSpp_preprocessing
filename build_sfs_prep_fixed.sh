...
# Build Fixed SFS Preprocessing Container
echo "=== Building Fixed SFS Preprocessing Container ==="

# Load modules
module load Apptainer/1.3.3

# Configuration
CONTAINER_NAME="sfs_prep_fixed.sif"
DEFINITION_FILE="sfs_prep_fixed.def"
BUILD_LOG="logs/sfs_prep_fixed_build.log"
