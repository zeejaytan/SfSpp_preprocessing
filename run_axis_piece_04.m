...
try
    fprintf('Starting axis extraction for Pot A, Piece 04\n');
    
    % Call the main axis extraction function
    vt = extract_axis('A', 04, false);
    
    % Save results
    output_file = sprintf('%s/Pot_A_Piece_04_Axis.txt', output_dir);
    writematrix(vt, output_file, 'Delimiter', ' ');
    
    fprintf('✅ Axis extraction completed for Piece 04\n');
