...
try
    fprintf('Starting axis extraction for Pot A, Piece 08\n');
    
    % Call the main axis extraction function
    vt = extract_axis('A', 08, false);
    
    % Save results
    output_file = sprintf('%s/Pot_A_Piece_08_Axis.txt', output_dir);
    writematrix(vt, output_file, 'Delimiter', ' ');
    
    fprintf('✅ Axis extraction completed for Piece 08\n');
